...
$hadir = $result->fetch_assoc()['total'];
$stmt->close();
...
<head>
    ...
    <title>Rekap Absensi - Absensi</title>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white shadow-lg hidden md:block">
            ...
            <nav class="mt-6">
                ...
                <a href="rekap.php" class="flex items-center gap-3 px-6 py-3 bg-gray-100 text-gray-700 border-r-4 border-gray-600">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 md:ml-64">
            ...
            <!-- Main Content -->
            <main class="p-6">
                <h1 class="text-2xl font-bold text-gray-700 mb-6">Rekap Absensi</h1>

                <!-- Date Filter -->
                <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
                    <form method="GET" class="flex flex-col md:flex-row gap-4 items-end">
                        <div class="flex-1">
                            <label class="block text-gray-600 text-sm font-medium mb-2">Pilih Tanggal</label>
                            <input 
                                type="date" 
                                name="tanggal"
                                value="<?php echo $tanggal; ?>"
                                class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-gray-400"
                            >
                        </div>
                        <button 
                            type="submit"
                            class="px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-xl transition-colors"
                        >
                            Filter
                        </button>
                    </form>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div class="bg-white rounded-2xl shadow-lg p-6">
                        ...
                        <p class="text-3xl font-bold text-gray-700"><?php echo $hadir; ?></p>
                    </div>
                    <div class="bg-white rounded-2xl shadow-lg p-6">
                        <p class="text-gray-400 text-sm">Total Peserta</p>
                        <p class="text-3xl font-bold text-gray-700"><?php echo $totalPeserta; ?></p>
                    </div>
                    <div class="bg-white rounded-2xl shadow-lg p-6">
                        <p class="text-gray-400 text-sm">Persentase</p>
                        <p class="text-3xl font-bold text-gray-700"><?php echo $totalPeserta > 0 ? round(($hadir / $totalPeserta) * 100) : 0; ?>%</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6 text-center text-gray-400">
                        <p>Tidak ada absensi pada tanggal tersebut</p>
                    </div>
                    <?php endif; ?>
                </div>
